...
Fisher et al. (1943) suggested three types of distributions for biological measurements, including the Poisson distribution for count variables. 
...
##save(keep_zip, keep_zinb,file="zinb_bycatch.RData")
